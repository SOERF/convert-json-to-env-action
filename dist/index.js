 ...
 */
var markdown_summary_1 = __nccwpck_require__(144);
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(829);
            }
            const agentOptions = {
...
var tslib_1 = __nccwpck_require__(502);
var no_case_1 = __nccwpck_require__(479);
var upper_case_1 = __nccwpck_require__(401);
...
var polyfills = __nccwpck_require__(218)
var legacy = __nccwpck_require__(251)
var clone = __nccwpck_require__(26)
...
let _fs
try {
  _fs = __nccwpck_require__(941)
} catch (_) {
  _fs = __nccwpck_require__(147)
}
const universalify = __nccwpck_require__(3)
const { stringify, stripBom } = __nccwpck_require__(389)
...
var lower_case_1 = __nccwpck_require__(931);
...
(() => {
const core = __nccwpck_require__(247)
const jsonfile = __nccwpck_require__(851)
const constantCase = __nccwpck_require__(165)
const _get = __nccwpck_require__(977);
